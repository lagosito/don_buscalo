  ...
  function ionicRatings () {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        scope.iconOn = scope.ratingsObj.iconOn || 'fa fa-star';
        scope.iconOff = scope.ratingsObj.iconOff || 'fa fa-star-o';
        ...
        scope.$watch("ratingsObj.rating", function(value) {
          ...
          scope.ratingsChanged(scope.rating);
        ...
        scope.ratingsChanged= function(val) {
          if (val < scope.minRating) {
            scope.rating = scope.minRating;
          } else {
            scope.rating = val;
          }
